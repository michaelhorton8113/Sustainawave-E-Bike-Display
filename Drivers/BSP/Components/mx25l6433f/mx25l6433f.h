...
typedef struct
{
  ...
  int32_t (*ReadID                  )(MX25L6433F_Object_t*, uint32_t*);
  ...
  int32_t (*PageProgram             )(MX25L6433F_Object_t*, MX25L6433F_Interface_t, uint8_t*, uint32_t, uint32_t);
  int32_t (*PageProgramDMA          )(MX25L6433F_Object_t*, MX25L6433F_Interface_t, uint8_t*, uint32_t, uint32_t);
